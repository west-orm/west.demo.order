...
public class ActivityOrderService {
	...
	public Object saveEntity(ActivityOrder entity) throws Exception {
		return dao.saveEntity(entity);
	}

	@Transactional
	public void update(ActivityOrder entity) throws Exception {
		dao.updateEntity(entity);
	}

	public ActivityOrder findEntityById(Long id) throws Exception {
	...
	public List<ActivityOrder> findEntityList(String[] keyName,
			String[] operate, Object[] keyValue, int pageSize, int pageNo)
			throws Exception {
		return dao.findEntityList(keyName, operate, keyValue, pageSize, pageNo);
	}

	public List<ActivityOrder> myEntityList(String userId) throws Exception {
	...
	public Page getEntityPage(ServletRequest request) throws Exception {
		...
		List<ActivityOrder> data = dao.findEntityList(names, opt, params, 1000,
				pageNO);
	...
	public Page getAllEntityPage(HttpServletRequest request) throws Exception {
		...
		int count = dao.getEntityCount(new String[] {}, new String[] {},
				new Object[] {}, null);
		List<ActivityOrder> data = dao.findEntityList(new String[] {},
