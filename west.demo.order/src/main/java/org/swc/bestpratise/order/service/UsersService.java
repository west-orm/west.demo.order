...
public class UsersService {
	...
	public Object saveEntity(Users entity) throws Exception {
	...
	public Users findEntityById(Long id) throws Exception {
	...
	public List<Users> findEntityList(String[] keyName, String[] operate,
	...
	public List<Users> myEntityList(String userId) throws Exception {
	...
	public Page getEntityPage(ServletRequest request) throws Exception {
		...
		List<Users> data = dao.findEntityList(names, opt, params, 1000, pageNO);
	...
	public Page getAllEntityPage(HttpServletRequest request) throws Exception {
		...
		int count = dao.getEntityCount(new String[] {}, new String[] {},
				new Object[] {}, null);
		List<Users> data = dao.findEntityList(new String[] {}, new String[] {},
				new Object[] {}, 10, pageNO);
