...
public class ProductService {
	...
	public Object saveEntity(Product entity) throws Exception {
	...
	public Product findEntityById(Long id) throws Exception {
	...
	public List<Product> findEntityList(String[] keyName, String[] operate,
	...
	public List<Product> myEntityList(String userId) throws Exception {
	...
	public Page getEntityPage(ServletRequest request) throws Exception {
		...
		List<Product> data = dao.findEntityList(names, opt, params, 1000,
				pageNO);
	...
	public Page getAllEntityPage(HttpServletRequest request) throws Exception {
		...
		int count = dao.getEntityCount(new String[] {}, new String[] {},
				new Object[] {}, null);
		List<Product> data = dao.findEntityList(new String[] {},
