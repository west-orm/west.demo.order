	...
	<body>
		<div class="navbar navbar-default" id="navbar">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div style="margin-right: 0;margin-top: 0;min-height: 100%;padding: 0;">
...
<div class="col-xs-12">
										<h3 class="header smaller lighter blue">${activity.title}订单详细</h3>
										<div class="row"><div class="col-sm-6">
										<button onclick="location.href='${ctx}/activity/order/list2?uuid=${activity.uuid}'">查看详细</button>
										</div></div>
										<div class="table-responsive">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
												<thead>
													<tr role="row"><th class="center sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="" style="width: 77px;">
														...
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 137px;">数量</th>
														<th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 148px;">金额</th>
											...
											<c:forEach items="${orderDetailList}" var="orderd">
											<tr class="odd">
														...
														<td class="hidden-480">
															<a href="#">${orderd.product}</a>
														</td>
														<td class=" ">${orderd.numx}</td>
														<td >
														${orderd.total_price}
														</td>
