...
<div class="col-xs-12">
										...
										<div class="row">
											<div class="col-xs-12">
											<c:if test="${acitity.status==1}">
												<button onclick="location.href='${ctx}/activity/orderdetail/addNon?uuid=${activity.uuid }'">点菜</button>
												<button onclick="location.href='${ctx}/activity/orderdetail/list2?uuid=${activity.uuid}'">下单</button>
												</c:if>
											</div>
										</div>
