...
<div class="col-xs-12">
										...
										<div class="row"><div class="col-sm-6"><button onclick="location.href='${ctx}/activity/list'">下单</button><button onclick="location.href='${ctx}/activity/list'">返回</button></div></div>
